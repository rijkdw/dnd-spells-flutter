...
class ConditionRepository extends ChangeNotifier {
  ...
  void startup() => print('ConditionRepository started up.');
...
"type": "bulletedlist",
"items": [
"A paralyzed creature is incapacitated (see the condition below) and can't move or speak.",
...
"The creature is incapacitated (see the condition below), can't move or speak, and is unaware of its surroundings.",
...
"type": "bulletedlist",
"items": [
"A stunned creature is incapacitated (see the condition below), can't move, and can speak only falteringly.",
"The creature automatically fails Strength and Dexterity saving throws.",
"Attack rolls against the creature have advantage."
],
"dependsOn": [
...
"type": "bulletedlist",
"items": [
"An unconscious creature is incapacitated (see the condition below), can't move or speak, and is unaware of its surroundings.",
